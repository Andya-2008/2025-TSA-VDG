...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            transform.position = Vector3.Lerp(transform.position, new Vector3(m_Target.position.x, m_Target.position.y+m_VerticalOffset, m_Target.position.z), deltaTime*m_MoveSpeed);
